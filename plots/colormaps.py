...
reds = LinearSegmentedColormap.from_list('myreds',[red0,red1],N=1000)
# Blues
blue0 = np.array([31, 119, 180, 0])/255
blue1 = np.array([31, 119, 180, 255])/255
blues = LinearSegmentedColormap.from_list('myreds',[blue0,blue1],N=1000)
# Greens
green0 = np.array([44, 160, 44, 0])/255
green1 = np.array([44, 160, 44, 255])/255
greens = LinearSegmentedColormap.from_list('myreds',[green0,green1],N=1000)
